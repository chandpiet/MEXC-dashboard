...
- Discord webhook hardcoded and ready

Run:
  streamlit run mexc_sr_dashboard_v3.py --server.port 8501
"""
...
def analyze(futures: str, equity: str, market_bias: str) -> AnalysisResult:
    try:
        ...
        if len(df_d) < 70:
            return AnalysisResult(futures=futures, equity=equity, last=0, error="Insufficient data")
        ...
        return AnalysisResult(futures=futures, equity=equity, last=0, error=str(e))
...
for sym, res in results.items():
    # Prefer live MEXC price for display
